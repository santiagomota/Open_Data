...
\item
  ...
  Government Portal}
\item
  \href{https://confluence.ecmwf.int/display/CEMS/CEMS-Flood+flood+inundation+maps}{CEMS-Flood
  flood inundation maps}
\item
  \href{https://ewds.climate.copernicus.eu/}{CEMS Early Warning Data
  Store}
\item
...
\item
  \href{https://confluence.ecmwf.int/display/CEMS/Copernicus+Emergency+Management+Service+-+CEMS+Home}{Copernicus
  Emergency Management Service - CEMS}
\item
  \href{https://emergency.copernicus.eu/}{Copernicus Emergency
  Management Service}
\item
...
\item
  ...
  (fMoW) Dataset}
\item
  \href{https://hub.worldpop.org/doi/10.5258/SOTON/WP00849}{Future
...
\item
  \href{https://source.coop/ftw/global-data}{Global Fields of The World
  (FTW)}
\item
...
\item
  \href{https://git.gfz-potsdam.de/globaldynamicexposure/openbuildingmap}{OpenBuildingMap}
\item
...
\item
  ...
  inference with INLA}
\item
  \href{https://oliviergimenez.github.io/banana-book/}{Bayesian analysis
  of capture-recapture data with hidden Markov models}
\item
...
\item
  \href{https://carpentries-incubator.github.io/r-geospatial-urban/}{Geospatial
  Data Carpentry for Urbanism}
\item
...
\item
  ...
  Analysis With R}
\item
  \href{https://duckdb.gishub.org/}{Spatial Data Management with DuckDB}
\item
