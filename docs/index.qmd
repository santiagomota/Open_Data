...
license:
  type: "MIT"
  text: "Este proyecto está licenciado bajo la Licencia MIT. Puedes ver los detalles en el siguiente enlace https://opensource.org/licenses/MIT"
...
format:
  html:
    ...
    toc-depth: 6
    theme: 
        light: cosmo   # flatly, cosmo, sandstone, yeti bootswatch theme
        dark: solar
    ...
    #     sidebar-width: 200px
    #     margin-width: 200px
    include-after-body: footer_V2.html
    # include-in-header: github-corner.html
    self-contained: true
  pdf:
    toc: true
    number-sections: true
...
::: {.grid}
::: {.g-col-4}
![https://github.com/santiagomota/Open_Data](figs/Open_Data_Github.png)
:::
::: {.g-col-4}
![https://santiagomota.github.io/Open_Data/](figs/Open_Data_Web_Github.png)
:::
::: {.g-col-4}
![https://open-data-pages.netlify.app/](figs/Open_Data_Web_Netlify.png)
:::
:::
...
- [APIs TomTom](https://developer.tomtom.com/api-explorer-index/documentation/product-information/introduction)
...
- [Catálogo de datos abiertos de la Comunidad de Madrid](https://datos.comunidad.madrid/catalogos/#/search?page=0&limit=20&order=date)
...
- [Contratos Registrados por municipios (SEPE)](https://datos.gob.es/es/catalogo/ea0041513-contratos-por-municipios)
...
- [Demandantes de Empleo por municipios (SEPE)](https://datos.gob.es/es/catalogo/ea0041513-demandantes-de-empleo-por-municipios)
...
- [Encuesta de Infraestructura y Equipamientos Locales (EIEL)](https://mptmd.gob.es/portal/politica-territorial/local/coop_econom_local_estado_fondos_europeos/eiel)
...
- [Freshwater Ecoregions of the World](https://www.worldwildlife.org/our-work/science/freshwater-ecoregions-of-the-world/)
...
- [RENFE - Trenes tiempo real largo recorrido](https://tiempo-real.largorecorrido.renfe.com/)
...
- Facebook Neural-Code-Search-Evaluation-Dataset [dataset]](https://github.com/facebookresearch/Neural-Code-Search-Evaluation-Dataset) y [noticia](https://venturebeat.com/technology/facebook-open-sources-data-set-for-code-search-ai-benchmark)
...
- Legalidad Web sraping: [Is Web Scraping Legal? : The Definitive Guide (2024 update)](https://prowebscraper.com/blog/is-web-scraping-legal/)
...
# Convert SVG to PNG
convert_svg_to_png <- function(input_svg, output_png) {
  img <- rsvg::rsvg_png(input_svg, file = output_png)
  message("Saved PNG: ", output_png)
}
