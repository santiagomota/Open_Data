...
- [ECMWF ERA5](https://www.ecmwf.int/en/forecasts/datasets/reanalysis-datasets/era5) - Hourly reanalysis climate data (temperature, precipitation, wind, etc.).
...
- [NASA Fire Information for Resource Management System (FIRMS)](https://firms.modaps.eosdis.nasa.gov/) - Near real-time data on wildfires from MODIS and VIIRS satellites.
